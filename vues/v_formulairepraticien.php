                ...
                <div class="col-lg-6 offset-lg-1 align-left">
                    <div class="row">
                        <form action="" method="post">
                            <label for="name">Nom du praticien :</form>
                            <input type="text" name="nompraticien" id="nompraticien" required></br></br>
                            <label for="name">Prénom du praticien :</form>
                            <input type="text" name="prenompraticien" id="prenompraticien" required></br></br>
