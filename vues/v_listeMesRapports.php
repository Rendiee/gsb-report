<section class="bg-light">
    <div class="container">
        <div class="structure-hero pt-lg-5 pt-4">
            <?php if (isset($dated) && isset($datef)) { ?>
                <h1 class="titre text-center">Tous les rapports du <?= date_format($dated, 'd/m/Y') . ' au ' . date_format($datef, 'd/m/Y') ?>
                <?php } elseif (isset($dated)) { ?>
                    <h1 class="titre text-center">Tous les rapports depuis le <?= date_format($dated, 'd/m/Y') ?>
                    <?php } else { ?>
                        <h1 class="titre text-center">Tous les rapports jusqu'au <?= date_format($datef, 'd/m/Y') ?>
                        <?php }
                    if ($pra) {
                        echo '<br/> du praticien ' . $infoMesRapports[0]['PRA_NOM'] . ' ' . $infoMesRapports[0]['PRA_PRENOM'];
                    } ?></h1>
        </div>
            ...
            <div class="test col-12 col-sm-9 col-lg-8 col-xl-7 py-3">
                <div class="mesRapports max-infos h-auto formulaire mb-0 mt-0 d-flex align-items-center flex-column justify-content-between pb-0">
                    <div class="w-100 d-flex flex-column">
                        ...
                        ?>
                            <form action="index.php?uc=rapportdevisite&action=mesrapports" method="post" class="d-flex flex-column w-100">
