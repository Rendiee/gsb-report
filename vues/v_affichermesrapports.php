    ...
    <div class="container">
        ...
        <div class="row align-items-center justify-content-center">
            <div class="test col-12 col-sm-9 col-lg-8 col-xl-7 py-3">
                <div class="rediger h-auto formulaire mb-0 mt-0 d-flex align-items-center flex-column justify-content-between overflow-auto pb-0">
                    ...
                    <div class="position-sticky bottom-0 retour-rap w-100 py-3">                        
                        <input class="btn btn-info text-light valider bouton-rapport" type="button" onclick="history.go(-1)" value="Retour">
                    </div>
                </div>
            </div>
        </div>
